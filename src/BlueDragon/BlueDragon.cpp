...
void BlueDragon::draw(sf::RenderTarget &target, sf::RenderStates states) const {
    sf::Sprite sprite;
    sprite.setPosition(sf::Vector2f(1100, 500));
    sf::Texture texture;
    texture.loadFromFile("/home/near/CLionProjects/dragons/res/blue_dragon/Dragonblue_img.png");
...
void BlueDragon::change_question() {
    int x = gen(1, 99);
    int y = gen(1, 99);
